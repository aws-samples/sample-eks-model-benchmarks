...
EKSBench's default deployment requires a Cognito user pool and an
...
handled upstream of EKSBench — you can disable in-app auth
...
EKSBench ships with two container-image overrides. Both are
