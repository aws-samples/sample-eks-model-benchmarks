...
// benchmark metrics including p50/p90/p95/p99 percentiles. When
// PrecomputedMetrics is set (inference-perf output), uses those directly;
// otherwise falls back to recomputing from per-request samples (legacy
// EKSBench loadgen).
